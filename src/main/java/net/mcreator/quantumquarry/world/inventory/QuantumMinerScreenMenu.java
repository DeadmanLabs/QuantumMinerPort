...
package net.mcreator.quantumquarry.world.inventory;
...
public class QuantumMinerScreenMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public QuantumMinerScreenMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(QuantumQuarryModMenus.QUANTUM_MINER_SCREEN.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 6, 38) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return QuantumQuarryModItems.BIOME_MARKER.get() == stack.getItem();
			}
		}));
